...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--keep_res', action='store_true',
                             help='keep the original resolution'
                                  ' during validation.')
    # tracking 
    self.parser.add_argument('--alltest_mot17', default=False, help='alltest_mot17')
    self.parser.add_argument('--alltrain_mot17', default=False, help='alltrain_mot17')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/media/zyf301/AE1EF53A1EF4FBE1/pengjq/MOTdata')

    # loss
    self.parser.add_argument('--mse_loss', action='store_true',
                             help='use mse loss or focal loss to train '
                                  'keypoint heatmaps.') # 默认为 False
    ...
    self.parser.add_argument('--ext_offset', default='none',
                             help='not regress local offset.')
    self.parser.add_argument('--siam_input', default='none',
                             help='feature_map | reid | none')
  ...
  def parse(self, args=''):
    ...
    # opt.ext_offset = not opt.not_ext_offset
    if opt.siam_input == 'double_hm':
      opt.arch = 'dladh_34'
    else:
      opt.arch = 'dla_34'

    print(opt.ext_offset, '=================================ext_offset===================================')
    print(opt.arch,'=================================arch===================================')
    print(opt.id_loss,'=================================id_loss===================================')
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    if opt.task == 'mot':
      ...
      if opt.ext_offset != 'none':
        opt.heads.update({'ext': 2})
      opt.nID = dataset.nID
